...
const ExperienceDetailScreen = ({ route, navigation }: any) => {
  const { id } = route.params || {};
  return (
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>Experiencia</Text>
        <Text style={styles.subtitle}>Detalle de experiencia {id}</Text>
...
const styles = StyleSheet.create({
  ...
  backButton: { marginTop: 16, padding: 12, backgroundColor: COLORS.primary, borderRadius: 8, alignItems: 'center' },
